...
object EnStrings : BioStrings {
    ...
    override val cancelRequestTitle = "Cancellation request"
    override fun cancelRequestedTxBody(agenName: String, volume: String) =
        "$agenName requested to cancel this $volume cooking oil transaction."
    override val approveCancelLabel = "Approve Cancellation"
    override val keepTransactionLabel = "Keep Transaction"
    ...
    override val pendingAgenNote = "Waiting for the Client to accept or reject in their app. Your stock increases after the Client accepts."
    override val rejectedAgenNote = "The Client rejected this transaction. Your stock remains unchanged."
    override val cancelRequestedAgenNote = "Waiting for the Client to approve your cancellation request."
    override val cancelledAgenNote = "This transaction was cancelled (approved by the Client). Your stock remains unchanged."
    override val requestCancelTransaction = "Request Cancellation"
    ...
    override val newTransactionNote = "Enter the Client's email or phone number. After submission, the Client will be asked to accept or reject it in their app."
    override val fieldClientEmail = "Client email"
    override val fieldClientPhone = "Client phone"
    override val fieldVolume = "Oil volume (liters)"
    override val fieldTransactionNote = "Note (optional)"
    override val placeholderClientEmail = "email@example.com"
    override val placeholderClientPhone = "e.g. 08xxxxxxxxxx"
    override val placeholderVolume = "e.g. 12.5"
    override val placeholderTransactionNote = "e.g. yellow jerrycan"
    override val checkingClientNote = "Checking Client details…"
    override fun clientFoundNote(name: String) = "Client found: $name"
    override val clientNotFoundNote = "This Client isn't registered on BioJelan yet. Double-check the email/phone."
    override val priceCalculatedByServerNote = "Price & total are calculated automatically from Kilang's active price — you'll see them after the transaction is sent."
    override val submitToClient = "Send to Client"

    override val errorClientContactRequired = "Enter the Client's email or phone."
    ...
    override val pendingKlienNote = "Check the amount and price. Accept if it matches what you handed to the Agent; reject if not."
    override val rejectNotUndoable = "This rejection cannot be undone."
    override val yesReject = "Yes, reject"
    override val approveCancelNotUndoable = "Approving this cancellation cannot be undone."
    override val yesApproveCancel = "Yes, approve"
